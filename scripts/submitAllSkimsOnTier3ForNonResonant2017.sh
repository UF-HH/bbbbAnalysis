...
python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8.txt             --puWeight=weights/2017/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_PUweights.root             --tag=$1  --cfg=config/skim_2017NonResonantDiHiggs4B.cfg   --xs=88.29   --no-tar --no-xrdcp-tar --njobs=100
python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/QCD_HT200to300_TuneCP5_13TeV-madgraph-pythia8.txt      --puWeight=weights/2017/QCD_HT200to300_TuneCP5_13TeV-madgraph-pythia8_PUweights.root      --tag=$1  --cfg=config/skim_2017NonResonantDiHiggs4B.cfg   --xs=1547000 --no-tar --no-xrdcp-tar --njobs=100
python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/QCD_HT300to500_TuneCP5_13TeV-madgraph-pythia8.txt      --puWeight=weights/2017/QCD_HT300to500_TuneCP5_13TeV-madgraph-pythia8_PUweights.root      --tag=$1  --cfg=config/skim_2017NonResonantDiHiggs4B.cfg   --xs=322600  --no-tar --no-xrdcp-tar --njobs=100
python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/QCD_HT500to700_TuneCP5_13TeV-madgraph-pythia8.txt      --puWeight=weights/2017/QCD_HT500to700_TuneCP5_13TeV-madgraph-pythia8_PUweights.root      --tag=$1  --cfg=config/skim_2017NonResonantDiHiggs4B.cfg   --xs=29980   --no-tar --no-xrdcp-tar --njobs=100
python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/QCD_HT700to1000_TuneCP5_13TeV-madgraph-pythia8.txt     --puWeight=weights/2017/QCD_HT700to1000_TuneCP5_13TeV-madgraph-pythia8_PUweights.root     --tag=$1  --cfg=config/skim_2017NonResonantDiHiggs4B.cfg   --xs=6334    --no-tar --no-xrdcp-tar --njobs=100
...
python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/GluGluHToBB_M125_TuneCP5_13TeV-powheg-pythia8.txt --puWeight=weights/2017/GluGluHToBB_M125_TuneCP5_13TeV-powheg-pythia8_PUweights.root --tag=$1 --cfg=config/skim_2017NonResonantDiHiggs4B.cfg --xs=30.52    --no-tar --no-xrdcp-tar --njobs=200
python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/VBFHToBB_M-125_13TeV_powheg_pythia8_weightfix.txt --puWeight=weights/2017/VBFHToBB_M-125_13TeV_powheg_pythia8_weightfix_PUweights.root --tag=$1 --cfg=config/skim_2017NonResonantDiHiggs4B.cfg --xs=3.861    --no-tar --no-xrdcp-tar --njobs=200
python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/WminusH_HToBB_WToQQ_M125_13TeV_powheg_pythia8.txt --puWeight=weights/2017/WminusH_HToBB_WToQQ_M125_13TeV_powheg_pythia8_PUweights.root --tag=$1 --cfg=config/skim_2017NonResonantDiHiggs4B.cfg --xs=0.3654   --no-tar --no-xrdcp-tar --njobs=200
...
python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/ZH_HToBB_ZToQQ_M125_13TeV_powheg_pythia8.txt      --puWeight=weights/2017/ZH_HToBB_ZToQQ_M125_13TeV_powheg_pythia8_PUweights.root      --tag=$1 --cfg=config/skim_2017NonResonantDiHiggs4B.cfg --xs=0.5242   --no-tar --no-xrdcp-tar --njobs=200
python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/ttHTobb_M125_TuneCP5_13TeV-powheg-pythia8.txt     --puWeight=weights/2017/ttHTobb_M125_TuneCP5_13TeV-powheg-pythia8_PUweights.root     --tag=$1 --cfg=config/skim_2017NonResonantDiHiggs4B.cfg --xs=0.5269   --no-tar --no-xrdcp-tar --njobs=200
python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/ZZTo4bQ01j_5f_TuneCP5_amcatNLO_FXFX_pythia8.txt   --puWeight=weights/2017/ZZTo4bQ01j_5f_TuneCP5_amcatNLO_FXFX_pythia8_PUweights.root   --tag=$1 --cfg=config/skim_2017NonResonantDiHiggs4B.cfg --xs=0.3682   --no-tar --no-xrdcp-tar --njobs=200

###Data in 2017
python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/Data_BTagCSV.txt --tag=$1  --cfg=config/skim_2017NonResonantDiHiggs4B.cfg --is-data --no-tar --no-xrdcp-tar --njobs=1000
...
for kl in `seq -f %g -19 1 20`; do
    ...
    # echo $kl, $klname
    python scripts/submitSkimOnTier3.py --kl-rew $kl --kl-map weights/gg_HH_4B_EFTnodes_2017.root --outputName GGHH4B_rew_kl_${klname} \
        --input=inputFiles/2017NonResonantDiHiggs4BDataSets/GluGluToHHTo4B_EFTnodes_13TeV-madgraph_correctedcfg.txt --puWeight=weights/2017/GluGluToHHTo4B_node_SM_13TeV-madgraph_correctedcfg_PUweights.root --tag=$1  --cfg=config/skim_2017NonResonantDiHiggs4B.cfg --is-signal  --xs=0.01043 --no-tar --no-xrdcp-tar --njobs=100  
done
...
###python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/QCD_bEnriched_HT300to500_TuneCP5_13TeV-madgraph-pythia8.txt      --puWeight=weights/2017/QCD_HT300to500_TuneCP5_13TeV-madgraph-pythia8_PUweights.root      --tag=$1  --cfg=config/skim_2017NonResonantDiHiggs4B.cfg   --xs=16620.0 --no-tar --no-xrdcp-tar --njobs=100
###python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/QCD_bEnriched_HT500to700_TuneCP5_13TeV-madgraph-pythia8.txt      --puWeight=weights/2017/QCD_HT500to700_TuneCP5_13TeV-madgraph-pythia8_PUweights.root      --tag=$1  --cfg=config/skim_2017NonResonantDiHiggs4B.cfg   --xs=1487.0  --no-tar --no-xrdcp-tar --njobs=100
###python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/QCD_bEnriched_HT700to1000_TuneCP5_13TeV-madgraph-pythia8.txt     --puWeight=weights/2017/QCD_HT700to1000_TuneCP5_13TeV-madgraph-pythia8_PUweights.root     --tag=$1  --cfg=config/skim_2017NonResonantDiHiggs4B.cfg   --xs=296.5   --no-tar --no-xrdcp-tar --njobs=100
###python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/QCD_bEnriched_HT1000to1500_TuneCP5_13TeV-madgraph-pythia8.txt    --puWeight=weights/2017/QCD_HT1000to1500_TuneCP5_13TeV-madgraph-pythia8_PUweights.root    --tag=$1  --cfg=config/skim_2017NonResonantDiHiggs4B.cfg   --xs=46.61   --no-tar --no-xrdcp-tar --njobs=100
###python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/QCD_bEnriched_HT1500to2000_TuneCP5_13TeV-madgraph-pythia8.txt    --puWeight=weights/2017/QCD_HT1500to2000_TuneCP5_13TeV-madgraph-pythia8_PUweights.root    --tag=$1  --cfg=config/skim_2017NonResonantDiHiggs4B.cfg   --xs=3.72    --no-tar --no-xrdcp-tar --njobs=100
###python scripts/submitSkimOnTier3.py --input=inputFiles/2017NonResonantDiHiggs4BDataSets/QCD_bEnriched_HT2000toInf_TuneCP5_13TeV-madgraph-pythia8.txt     --puWeight=weights/2017/QCD_HT2000toInf_TuneCP5_13TeV-madgraph-pythia8_PUweights.root     --tag=$1  --cfg=config/skim_2017NonResonantDiHiggs4B.cfg   --xs=0.6462  --no-tar --no-xrdcp-tar --njobs=100