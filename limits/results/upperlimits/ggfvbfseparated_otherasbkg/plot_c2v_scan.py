...
for ipt, lam in enumerate(lambdas):
	...
	if xval==1.0:
		print " "
		print "========================================================================="
		print "Unblinding HH->bbbb analysis: c2v coupling in mu_vbf fit (mu_ggf=1 as bkg)"
		print "Coupling   = ",xval
...
#graph2 = ROOT.TGraph("../../../testline/config/vbfhhc2vline.txt")
#graph2.SetLineColor(8)
#graph2.SetLineWidth(3)
#for k in range (0,graph2.GetN()): graph2.GetY()[k] *= scaleToXS

hframe = ROOT.TH1F('hframe', '', 100, -2, 4.0)
hframe.SetMinimum(0.5)
hframe.SetMaximum(90000)
...
hframe.GetYaxis().SetTitle("#sigma_{VBF} (pp#rightarrowHHjj) [fb]")
hframe.GetXaxis().SetTitle("#kappa_{2V}")
