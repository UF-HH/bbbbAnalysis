...
parser.add_argument('--coupling', dest='coupling',help='Coupling: (1) C3, (2) C2V, (3) CV', required = True)
...
##Couplings
if coupling=='C2V' or coupling=='CV' or coupling=='C3':
...
pt5 = ROOT.TPaveText(0.4819196+0.036,0.7780357+0.015+0.02,0.9008929,0.8675595+0.015,"brNDC")
pt5.SetTextAlign(12)
