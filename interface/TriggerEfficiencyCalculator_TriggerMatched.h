...
#include "TriggerFitCurves2016_TriggerMatched.h"
#include "TriggerFitCurves2017_TriggerMatched.h"
#include "TriggerFitCurves2018_TriggerMatched.h"

class TriggerEfficiencyCalculator_TriggerMatched
{
public:
    TriggerEfficiencyCalculator_TriggerMatched(NanoAODTree& nat);
    virtual ~TriggerEfficiencyCalculator_TriggerMatched();
...
class TriggerEfficiencyCalculator_TriggerMatched_2016 : public TriggerEfficiencyCalculator_TriggerMatched
{
public:
    TriggerEfficiencyCalculator_TriggerMatched_2016(std::string inputFileName, NanoAODTree& nat);
    ~TriggerEfficiencyCalculator_TriggerMatched_2016();
...
private:
    ...
    TriggerFitCurves2016_TriggerMatched fTriggerFitCurves;
...
class TriggerEfficiencyCalculator_TriggerMatched_2017 : public TriggerEfficiencyCalculator_TriggerMatched
{
public:
    TriggerEfficiencyCalculator_TriggerMatched_2017(std::string inputFileName, NanoAODTree& nat);
    ~TriggerEfficiencyCalculator_TriggerMatched_2017();
...
private:
    ...
    TriggerFitCurves2017_TriggerMatched fTriggerFitCurves;
    float pt1_         {0.};
    float pt2_         {0.};
    float pt3_         {0.};
    float pt4_         {0.};
...
class TriggerEfficiencyCalculator_TriggerMatched_2018 : public TriggerEfficiencyCalculator_TriggerMatched
{
public:
    TriggerEfficiencyCalculator_TriggerMatched_2018(std::string inputFileName, NanoAODTree& nat);
    ~TriggerEfficiencyCalculator_TriggerMatched_2018();
    bool isPassingTurnOnCuts(std::vector<std::string> listOfPassedTriggers, const std::vector<Jet>& selectedJets) override {return false;}
...
private:
    ...
    TriggerFitCurves2018_TriggerMatched fTriggerFitCurves;
    float pt1_         {0.} ;
    float pt2_         {0.} ;
    float pt3_         {0.} ;
    float pt4_         {0.} ;
