...
for ipt, lam in enumerate(lambdas):
	...
	#kl = kl.replace('.', 'd')
	# print kl
	if categid=='2' and dataid=='2' and kl=='p_0.9':
		xs    = coupling_xs[k]
		obs   = scaleToXS*0.0 ## FIXME
		m2s_t = 171.8750*xs*scaleToXS
		m1s_t = 1992.8589*xs*scaleToXS
		exp   = 2000.0000*xs*scaleToXS
		p1s_t = 4024.9097*xs*scaleToXS
		p2s_t = 6065.6392*xs*scaleToXS
	else:
