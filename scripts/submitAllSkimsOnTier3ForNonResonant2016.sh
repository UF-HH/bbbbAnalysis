...
python scripts/submitSkimOnTier3.py --input=inputFiles/2016NonResonantDiHiggs4BDataSets/VBF_HH_CV_1_C2V_1_C3_1_dipoleRecoilOff-TuneCUETP8M1_PSweights_13TeV-madgraph-pythia8.txt      --puWeight=weights/2016/PUweights_2016.root   --tag=$1 --cfg=config/skim_2016NonResonantDiHiggs4B.cfg --is-signal --xs=0.000585   --njobs=10
python scripts/submitSkimOnTier3.py --input=inputFiles/2016NonResonantDiHiggs4BDataSets/VBF_HH_CV_1_C2V_2_C3_1_dipoleRecoilOff-TuneCUETP8M1_PSweights_13TeV-madgraph-pythia8.txt      --puWeight=weights/2016/PUweights_2016.root   --tag=$1 --cfg=config/skim_2016NonResonantDiHiggs4B.cfg --is-signal --xs=0.004823   --njobs=10
...
python scripts/submitSkimOnTier3.py --kl-rew 7.5    --kt-rew 1  --c2-rew  -1    --cg-rew  0      --c2g-rew  0    --kl-map weights/gg_HH_4B_EFTnodes_2016.root --outputName GGHH4B_rew_bench_1 \
        --input=inputFiles/2016NonResonantDiHiggs4BDataSets/GluGluToHHTo4B_EFTnodes_13TeV-madgraph.txt     --puWeight=weights/2016/PUweights_2016.root     --tag=$1 --cfg=config/skim_2016NonResonantDiHiggs4B.cfg --is-signal  --xs=0.001 --njobs=200
