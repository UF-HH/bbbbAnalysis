...
int main(int argc, char** argv)
{
    ...
    tOut->Branch("jet1_DeepB",    &jet1_DeepB_);
    ...
    tOut->Branch("jet2_DeepB",    &jet2_DeepB_);
    ...
    tOut->Branch("jet3_DeepB",    &jet3_DeepB_);
    ...
    tOut->Branch("jet4_DeepB",    &jet4_DeepB_);
    ...
    for (int iEv = 0; true; ++iEv)
    {
        ...
        for (uint ij = 0; ij < *(nat.nJet); ++ij)
        {
            ...
            if (!checkBit(puid, 1)) // medium PU Id
                continue;
        ...
        if (get_property(all_jets.at(2), Jet_btagDeepB) <= deepB_WPmedium) // skip if the first 3 jets are not b tagged
            continue;
        ...
        jet1_DeepB_    = get_property(all_jets.at(0), Jet_btagDeepB);
        ...
        jet2_DeepB_    = get_property(all_jets.at(1), Jet_btagDeepB);
        ...
        jet3_DeepB_    = get_property(all_jets.at(2), Jet_btagDeepB);
        ...
        jet4_DeepB_    = get_property(all_jets.at(3), Jet_btagDeepB);
