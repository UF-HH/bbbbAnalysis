...
TriggerEfficiencyCalculator_TriggerMatched::TriggerEfficiencyCalculator_TriggerMatched(NanoAODTree& nat)
: theNanoAODTree_(nat)
{}

TriggerEfficiencyCalculator_TriggerMatched::~TriggerEfficiencyCalculator_TriggerMatched()
{}

std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched::getTriggerScaleFactor(const std::vector<Jet>& selectedJets)
{
...
std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched::getDataTriggerEfficiency(const std::vector<Jet>& selectedJets)
{
    extractInformationFromEvent(selectedJets);
    return calculateDataTriggerEfficiency();
}

std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched::getMonteCarloTriggerEfficiency(const std::vector<Jet>& selectedJets)
{
    extractInformationFromEvent(selectedJets);
    return calculateMonteCarloTriggerEfficiency();
}

std::tuple<std::tuple<float,float,float>, std::tuple<float,float,float>, std::tuple<float,float,float>> TriggerEfficiencyCalculator_TriggerMatched::getScaleFactorDataAndMonteCarloEfficiency(const std::vector<Jet>& selectedJets)
{
    extractInformationFromEvent(selectedJets);
    std::tuple<float, float, float> dataEfficiency       = calculateDataTriggerEfficiency();
    std::tuple<float, float, float> monteCarloEfficiency = calculateMonteCarloTriggerEfficiency();
...
void TriggerEfficiencyCalculator_TriggerMatched::simulateTrigger(OutputTree* theOutputTree)
{
...
TriggerEfficiencyCalculator_TriggerMatched_2016::TriggerEfficiencyCalculator_TriggerMatched_2016(std::string inputFileName, NanoAODTree& nat)
: TriggerEfficiencyCalculator_TriggerMatched(nat)
, fTriggerFitCurves(inputFileName)
{}

TriggerEfficiencyCalculator_TriggerMatched_2016::~TriggerEfficiencyCalculator_TriggerMatched_2016()
{}

bool TriggerEfficiencyCalculator_TriggerMatched_2016::isPassingTurnOnCuts(std::vector<std::string> listOfPassedTriggers, const std::vector<Jet>& selectedJets)
{
    extractInformationFromEvent(selectedJets);
...
std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched_2016::calculateDataTriggerEfficiency()
{
...
std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched_2016::calculateMonteCarloTriggerEfficiency()
{
...
std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched_2016::calculateDataDouble90Double30Efficiency()
{
    #ifdef useFit
...
std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched_2016::calculateDataQuad45Efficiency()
{
...
std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched_2016::calculateDataAndEfficiency()
{
...
std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched_2016::calculateMonteCarloDouble90Double30Efficiency()
{
    #ifdef useFit
...
std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched_2016::calculateMonteCarloQuad45Efficiency()
{
...
std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched_2016::calculateMonteCarloAndEfficiency()
{
...
void TriggerEfficiencyCalculator_TriggerMatched_2016::extractInformationFromEvent(std::vector<Jet> selectedJets)
{
...
void  TriggerEfficiencyCalculator_TriggerMatched_2016::createTriggerSimulatedBranches()
{
...
void  TriggerEfficiencyCalculator_TriggerMatched_2017::createTriggerSimulatedBranches()
{
    theOutputTree_->declareUserIntBranch("HLT_Simulated"      , 0);
    theOutputTree_->declareUserIntBranch("HLT_SimulatedUp"    , 0);
    theOutputTree_->declareUserIntBranch("HLT_SimulatedDown"  , 0);
...
TriggerEfficiencyCalculator_TriggerMatched_2017::TriggerEfficiencyCalculator_TriggerMatched_2017(std::string inputFileName, NanoAODTree& nat)
: TriggerEfficiencyCalculator_TriggerMatched(nat)
, fTriggerFitCurves(inputFileName)
{}

TriggerEfficiencyCalculator_TriggerMatched_2017::~TriggerEfficiencyCalculator_TriggerMatched_2017()
{}

void TriggerEfficiencyCalculator_TriggerMatched_2017::extractInformationFromEvent(std::vector<Jet> selectedJets)
{
...
std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched_2017::calculateDataTriggerEfficiency()
{
    #ifdef useFit
    ...
    #else
        static_assert(false, "Do not use fit not implemented for TriggerEfficiencyCalculator_TriggerMatched_2017");
    #endif
...
std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched_2017::calculateMonteCarloTriggerEfficiency()
{
    #ifdef useFit
...
TriggerEfficiencyCalculator_TriggerMatched_2018::TriggerEfficiencyCalculator_TriggerMatched_2018(std::string inputFileName, NanoAODTree& nat)
: TriggerEfficiencyCalculator_TriggerMatched(nat)
, fTriggerFitCurves(inputFileName)
{}

TriggerEfficiencyCalculator_TriggerMatched_2018::~TriggerEfficiencyCalculator_TriggerMatched_2018()
{}

void  TriggerEfficiencyCalculator_TriggerMatched_2018::createTriggerSimulatedBranches()
{
    theOutputTree_->declareUserIntBranch("HLT_Simulated"      , 0);
    theOutputTree_->declareUserIntBranch("HLT_SimulatedUp"    , 0);
    theOutputTree_->declareUserIntBranch("HLT_SimulatedDown"  , 0);
...
void TriggerEfficiencyCalculator_TriggerMatched_2018::extractInformationFromEvent(std::vector<Jet> selectedJets)
{
...
std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched_2018::calculateDataTriggerEfficiency()
{
    #ifdef useFit
    ...
    #else
        static_assert(false, "Do not use fit not implemented for TriggerEfficiencyCalculator_TriggerMatched_2018");
    #endif
...
std::tuple<float, float, float> TriggerEfficiencyCalculator_TriggerMatched_2018::calculateMonteCarloTriggerEfficiency()
{
    #ifdef useFit
