...
// namespace TriggerFitCurves2016_TriggerMatched
// {
...
class TriggerFitCurves2016_TriggerMatched
{
    ...
    public:
        ...
        TriggerFitCurves2016_TriggerMatched(std::string fileName)
        ...
        ~TriggerFitCurves2016_TriggerMatched()
        {
