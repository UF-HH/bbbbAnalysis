...
for parameter in "${slopeparameter[@]}"; do
       python scripts/submitPairingSkimOnTier3.py --bbbbChoice BothClosestToDiagonal --mh1mh2 ${parameter} --outputName=GluGluToHHTo4B_node_cHHH1_TuneCP5_PSWeights_13TeV-powheg-pythia8_${parameter}                --input=inputFiles/2017NonResonantDiHiggs4BDataSets/GluGluToHHTo4B_node_cHHH1_TuneCP5_PSWeights_13TeV-powheg-pythia8.txt                  --puWeight=weights/2017/GluGluToHHTo4B_node_SM_TuneCP5_PSWeights_13TeV-madgraph-pythia8_PUweights.root --tag=$1 --cfg=config/skim_2017NonResonantDiHiggs4B.cfg --is-signal --xs=0.010517  --njobs=20  --is-nlo-sig
       python scripts/submitPairingSkimOnTier3.py --bbbbChoice BothClosestToDiagonal --mh1mh2 ${parameter} --outputName=GluGluToHHTo4B_node_cHHH5_TuneCP5_PSWeights_13TeV-powheg-pythia8_${parameter}                --input=inputFiles/2017NonResonantDiHiggs4BDataSets/GluGluToHHTo4B_node_cHHH5_TuneCP5_PSWeights_13TeV-powheg-pythia8.txt                  --puWeight=weights/2017/GluGluToHHTo4B_node_SM_TuneCP5_PSWeights_13TeV-madgraph-pythia8_PUweights.root --tag=$1 --cfg=config/skim_2017NonResonantDiHiggs4B.cfg --is-signal --xs=0.031072  --njobs=20  --is-nlo-sig
       python scripts/submitPairingSkimOnTier3.py --bbbbChoice BothClosestToDiagonal --mh1mh2 ${parameter} --outputName=VBF_HH_CV_1_C2V_1_C3_1_dipoleRecoilOff-TuneCP5_PSweights_13TeV-madgraph-pythia8_${parameter} --input=inputFiles/2017NonResonantDiHiggs4BDataSets/VBF_HH_CV_1_C2V_1_C3_1_dipoleRecoilOff-TuneCP5_PSweights_13TeV-madgraph-pythia8.txt   --puWeight=weights/2017/GluGluToHHTo4B_node_SM_TuneCP5_PSWeights_13TeV-madgraph-pythia8_PUweights.root --tag=$1 --cfg=config/skim_2017NonResonantDiHiggs4B.cfg --is-signal --xs=0.000585  --njobs=20  --is-VBF-sig
       python scripts/submitPairingSkimOnTier3.py --bbbbChoice BothClosestToDiagonal --mh1mh2 ${parameter} --outputName=VBF_HH_CV_1_C2V_2_C3_1_dipoleRecoilOff-TuneCP5_PSweights_13TeV-madgraph-pythia8_${parameter} --input=inputFiles/2017NonResonantDiHiggs4BDataSets/VBF_HH_CV_1_C2V_2_C3_1_dipoleRecoilOff-TuneCP5_PSweights_13TeV-madgraph-pythia8.txt   --puWeight=weights/2017/GluGluToHHTo4B_node_SM_TuneCP5_PSWeights_13TeV-madgraph-pythia8_PUweights.root --tag=$1 --cfg=config/skim_2017NonResonantDiHiggs4B.cfg --is-signal --xs=0.004823  --njobs=20  --is-VBF-sig  
done
