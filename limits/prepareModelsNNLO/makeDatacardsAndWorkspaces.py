...
if args.doworkspace:
    ...
    if datas[0] != 'data_obs':
        for card in datacards: os.system('text2workspace.py %s -D %s -P HHModelPinv:HHdefault --PO doNNLOscaling=true &'%(card, datas[0]))
        #for card in datacards: os.system('text2workspace.py %s -D %s -P HHModel:HHdefault &'%(card, datas[0]))
    else:
        for card in datacards: os.system('text2workspace.py %s -P HHModelPinv:HHdefault --PO doNNLOscaling=true &'%card)
