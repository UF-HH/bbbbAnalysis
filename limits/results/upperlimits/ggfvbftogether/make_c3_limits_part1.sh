...
#for c3 in `seq -f %.1f 1.0 1.0 1.0`; do
    ...
    combine \
        ...
        -n kl_${c3name} \
        --freezeParameters THU_HH,pdf_Higgs_gg,mtop_ggHH,QCDscale_qqHH,pdf_Higgs_qq #,BR_decay_hbbhbb #This is for including syst on xs limit #Include BR_decay_hbbhbb if quoting xs*B limit  
