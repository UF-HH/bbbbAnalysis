...
histograms=(BDT2 BDT3 JJ_m j1j2_deltaEta HH_m) #nJet HH_m BDT1 H1_pt H2_pt H1_eta H2_eta H1_bb_deltaR H2_bb_deltaR JJ_m j1j2_deltaEta)
...
do
       ...
       do
            ...
            do
       	    ...
       	    echo "Done with the folder $folder in 2016"
       done
done  
cd ..
rm -r Histos2016skim++
