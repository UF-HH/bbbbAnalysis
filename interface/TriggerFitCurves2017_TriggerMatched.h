...
class TriggerFitCurves2017_TriggerMatched
{
    ...
    public:
        ...
        TriggerFitCurves2017_TriggerMatched(std::string fileName)
        : triggerFitFile(fileName.data())
        {
            ...
            fSingleMuon__Efficiency_CaloQuadJet30HT300Pair = createPair(
                ((TGraphAsymmErrors*)triggerFitFile.Get("SingleMuon__Efficiency_CaloQuadJet30HT300"))->GetFunction("cdf"),
                (KFitResult*)triggerFitFile.Get("SingleMuon__Efficiency_CaloQuadJet30HT300_FitResult")
            );

            fSingleMuon__Efficiency_BTagCaloCSVp05DoublePair = createPair(
                ((TGraphAsymmErrors*)triggerFitFile.Get("SingleMuon__Efficiency_BTagCaloCSVp05Double"))->GetFunction("cdf"),
            ...
            fSingleMuon__Efficiency_PFCentralJetsLooseIDQuad30HT300Pair = createPair(
                ((TGraphAsymmErrors*)triggerFitFile.Get("SingleMuon__Efficiency_PFCentralJetsLooseIDQuad30HT300"))->GetFunction("cdf"),
                (KFitResult*)triggerFitFile.Get("SingleMuon__Efficiency_PFCentralJetsLooseIDQuad30HT300_FitResult")
            );

            fSingleMuon__Efficiency_BTagPFCSVp070TriplePair = createPair(
                ((TGraphAsymmErrors*)triggerFitFile.Get("SingleMuon__Efficiency_BTagPFCSVp070Triple"))->GetFunction("cdf"),
            ...
            fTTbar__Efficiency_CaloQuadJet30HT300Pair = createPair(
                ((TGraphAsymmErrors*)triggerFitFile.Get("TTbar__Efficiency_CaloQuadJet30HT300"))->GetFunction("cdf"),
                (KFitResult*)triggerFitFile.Get("TTbar__Efficiency_CaloQuadJet30HT300_FitResult")
            );

            fTTbar__Efficiency_BTagCaloCSVp05DoublePair = createPair(
                ((TGraphAsymmErrors*)triggerFitFile.Get("TTbar__Efficiency_BTagCaloCSVp05Double"))->GetFunction("cdf"),
            ...
            fTTbar__Efficiency_PFCentralJetsLooseIDQuad30HT300Pair = createPair(
                ((TGraphAsymmErrors*)triggerFitFile.Get("TTbar__Efficiency_PFCentralJetsLooseIDQuad30HT300"))->GetFunction("cdf"),
                (KFitResult*)triggerFitFile.Get("TTbar__Efficiency_PFCentralJetsLooseIDQuad30HT300_FitResult")
            );

            fTTbar__Efficiency_BTagPFCSVp070TriplePair = createPair(
                ((TGraphAsymmErrors*)triggerFitFile.Get("TTbar__Efficiency_BTagPFCSVp070Triple"))->GetFunction("cdf"),
                (KFitResult*)triggerFitFile.Get("TTbar__Efficiency_BTagPFCSVp070Triple_FitResult")
            );


        }
        ~TriggerFitCurves2017_TriggerMatched()
        {
